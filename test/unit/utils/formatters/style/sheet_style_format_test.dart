...
// import 'package:sheets/core/data/events/set_border_event.dart';
...
//         Border? border = data.getCellProperties(cell).config.border;
...
//       for (CellIndex cell in intent.selectedCells) {
//         data.setCellStyle(cell, data.getCellProperties(cell).config.copyWith(border: border));
//       }
//
//       // Act
//       action.format(data);
...
//       // Assert
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(0), column: ColumnIndex(0))).config.border?.top.color,
//         Colors.blue,
//       );
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(1), column: ColumnIndex(0))).config.border?.bottom.color,
//         Colors.blue,
//       );
//     });
//
...
//       // Assert
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(0), column: ColumnIndex(0))).config.border?.left.color,
//         Colors.green,
//       );
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(0), column: ColumnIndex(1))).config.border?.right.color,
//         Colors.green,
//       );
//     });
//
...
//       // Assert
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(0), column: ColumnIndex(0))).config.border?.bottom.color,
//         Colors.red,
//       );
//       expect(
//         data.getCellProperties(CellIndex(row: RowIndex(0), column: ColumnIndex(1))).config.border?.left.color,
//         Colors.red,
//       );
//     });
//   });
