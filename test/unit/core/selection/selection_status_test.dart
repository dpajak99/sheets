...
void main() {
  ...
  group('Tests of SelectionStatus.selectValue', (){
    test('Should [return "fullySelected"] if status is FULLY SELECTED', (){
      // Act
      String actualValue = SelectionStatus(true, true).selectValue(
    ...
    test('Should [return "selected"] if status is SELECTED', (){
      // Act
      String actualValue = SelectionStatus(true, false).selectValue(
        notSelected: 'notSelected',
        selected: 'selected',
        fullySelected: 'fullySelected'
      );
    ...
    test('Should [return "notSelected"] if status is NOT SELECTED', (){
      // Act
      String actualValue = SelectionStatus(false, false).selectValue(
        notSelected: 'notSelected',
        selected: 'selected',
        fullySelected: 'fullySelected'
      );
