  ...
  group('CssFontSize', () {
    group('fromDart', () {
      ...
      test('should create CssFontSize from FontSize', () {
        ...
        // Assert
        expect(cssFontSize?.toCssMap(), {'font-size': '12.0pt'});
      });
    });
    ...
    group('fromCssMap', () {
      test('should return null when no supported property is present', () {
        // Arrange
        Map<String, String> cssMap = {'color': '#000000'};
      ...
      test('should parse font size from CSS map', () {
        // Arrange
        Map<String, String> cssMap = {'font-size': '16px'};
    ...
    group('toCssMap', () {
      test('should return correct CSS map', () {
        ...
        // Assert
        expect(cssMap, {'font-size': '12.0pt'});
      });
    });
  });
