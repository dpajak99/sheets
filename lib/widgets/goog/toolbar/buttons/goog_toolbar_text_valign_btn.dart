...
class GoogToolbarTextValignBtn extends StatefulWidget implements StaticSizeWidget {
  const GoogToolbarTextValignBtn({
    required this.value,
  ...
  @override
  State<StatefulWidget> createState() => _GoogToolbarTextValignBtnState();
}

class _GoogToolbarTextValignBtnState extends State<GoogToolbarTextValignBtn> {
