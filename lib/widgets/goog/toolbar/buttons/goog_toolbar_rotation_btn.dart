...
class GoogToolbarRotationBtn extends StatefulWidget implements StaticSizeWidget {
  const GoogToolbarRotationBtn({
    required this.value,
  ...
  @override
  State<StatefulWidget> createState() => _GoogToolbarRotationBtnState();
}

class _GoogToolbarRotationBtnState extends State<GoogToolbarRotationBtn> {
