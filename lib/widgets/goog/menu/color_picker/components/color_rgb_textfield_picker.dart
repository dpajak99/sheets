...
class _ColorRGBTextfieldPickerState extends State<ColorRGBTextfieldPicker> {
  ...
  void initState() {
    super.initState();
    _redController = _ColorController(() => widget.color.r);
    _greenController = _ColorController(() => widget.color.g);
    _blueController = _ColorController(() => widget.color.b);
  }
  ...
  void _onColorChanged({int? red, int? green, int? blue}) {
    widget.onChanged(Color.fromARGB(
      255,
      (red != null && red >= 0 && red <= 255) ? red : widget.color.r.toInt(),
      (green != null && green >= 0 && green <= 255) ? green : widget.color.g.toInt(),
      (blue != null && blue >= 0 && blue <= 255) ? blue : widget.color.b.toInt(),
    ));
  }
}
...
class _ColorController {
  ...
  late final double Function() _colorBuilder;
