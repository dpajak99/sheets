              ...
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    ...
                    GoogHeaderControlButton(child: GoogText(t.menu.insert.name), popupBuilder: (_) => const GoogInsertControlMenu()),
                    GoogHeaderControlButton(child: GoogText(t.menu.format.name), popupBuilder: (_) => const GoogFormatControlMenu()),
                    GoogHeaderControlButton(child: GoogText(t.menu.data.name), popupBuilder: (_) => const GoogDataControlMenu()),
                    GoogHeaderControlButton(child: GoogText(t.menu.tools.name), popupBuilder: (_) => const GoogToolsControlMenu()),
