...
class SheetPopup {
  ...
  static final Map<int, OverlayEntry> _currentlyOpenGlobalPopups = <int, OverlayEntry>{};
  ...
  static void _closePopupsAtOrAboveLevel(int level) {
    List<int> levelsToClose = _currentlyOpenGlobalPopups.keys.where((int l) => l >= level).toList(); // To avoid concurrent modification
