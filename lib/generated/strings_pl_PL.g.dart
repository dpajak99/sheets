...
class _TranslationsBottomBarPlPl implements TranslationsBottomBarEn {
	...
	// Translations
	@override String get tab_name => 'Arkusz{index}';
...
class _TranslationsColumnMenuMoreOptionsPlPl implements TranslationsColumnMenuMoreOptionsEn {
	...
	// Translations
	@override String get freeze => 'Zablokuj kolumny do {index}';
...
class _TranslationsRowMenuMoreOptionsPlPl implements TranslationsRowMenuMoreOptionsEn {
	...
	// Translations
	@override String get freeze => 'Zablokuj dp wiersza {index}';
...
class _TranslationsMenuEditDeleteOptionsPlPl implements TranslationsMenuEditDeleteOptionsEn {
	...
	@override String get row => 'Wiersz {index}';
	@override String get column => 'Kolumna {index}';
...
class _TranslationsMenuViewFreezeOptionsPlPl implements TranslationsMenuViewFreezeOptionsEn {
	...
	@override String get up_to_current_row => 'Do wiersza {index}';
	...
	@override String get up_to_current_column => 'Do kolumny {index}';
}
...
class _TranslationsMenuDataSortSheetOptionsPlPl implements TranslationsMenuDataSortSheetOptionsEn {
	...
	// Translations
	@override String get by_column_asc => 'Sortuj arkusz według kolumny {index} (Od A do Z)';
	@override String get by_column_desc => 'Sortuj arkusz według kolumny {index} (Od Z do A)';
}
...
class _TranslationsMenuDataSortRangeOptionsPlPl implements TranslationsMenuDataSortRangeOptionsEn {
	...
	// Translations
	@override String get by_column_asc => 'Sortuj zakres według kolumny {index} (Od A do Z)';
	@override String get by_column_desc => 'Sortuj zakres według kolumny {index} (Od Z do A)';
...
extension on TranslationsPlPl {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'menu.edit.delete_options.column': return 'Kolumna {index}';
			...
			case 'menu.view.freeze_options.up_to_current_row': return 'Do wiersza {index}';
			...
			case 'menu.view.freeze_options.up_to_current_column': return 'Do kolumny {index}';
			...
			case 'menu.data.sort_sheet_options.by_column_asc': return 'Sortuj arkusz według kolumny {index} (Od A do Z)';
			case 'menu.data.sort_sheet_options.by_column_desc': return 'Sortuj arkusz według kolumny {index} (Od Z do A)';
			case 'menu.data.sort_range': return 'Sortuj zakres';
			case 'menu.data.sort_range_options.by_column_asc': return 'Sortuj zakres według kolumny {index} (Od A do Z)';
			case 'menu.data.sort_range_options.by_column_desc': return 'Sortuj zakres według kolumny {index} (Od Z do A)';
			...
			case 'column_menu.more_options.freeze': return 'Zablokuj kolumny do {index}';
			...
			case 'row_menu.more_options.freeze': return 'Zablokuj dp wiersza {index}';
			...
			case 'bottom_bar.tab_name': return 'Arkusz{index}';
