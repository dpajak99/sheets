...
class TranslationsBottomBarEn {
	...
	// Translations
	String get tab_name => 'Sheet{index}';
...
class TranslationsColumnMenuMoreOptionsEn {
	...
	// Translations
	String get freeze => 'Freeze up to column {index}';
...
class TranslationsRowMenuMoreOptionsEn {
	...
	// Translations
	String get freeze => 'Freeze up to row {index}';
...
class TranslationsMenuEditDeleteOptionsEn {
	...
	String get row => 'Row {index}';
	String get column => 'Column {index}';
...
class TranslationsMenuViewFreezeOptionsEn {
	...
	String get up_to_current_row => 'Up to row {index}';
	String get no_columns => 'No columns';
	String get k1Column => '1 column';
	String get k2Columns => '2 columns';
	String get up_to_current_column => 'Up to column {index}';
}
...
class TranslationsMenuDataSortSheetOptionsEn {
	...
	// Translations
	String get by_column_asc => 'Sort sheet by column {index} (A to Z)';
	String get by_column_desc => 'Sort sheet by column {index} (Z to A)';
}
...
class TranslationsMenuDataSortRangeOptionsEn {
	...
	// Translations
	String get by_column_asc => 'Sort range by column {index} (A to Z)';
	String get by_column_desc => 'Sort range by column {index} (Z to A)';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'menu.edit.delete_options.column': return 'Column {index}';
			...
			case 'menu.view.freeze_options.up_to_current_row': return 'Up to row {index}';
			...
			case 'menu.view.freeze_options.up_to_current_column': return 'Up to column {index}';
			...
			case 'menu.data.sort_sheet_options.by_column_asc': return 'Sort sheet by column {index} (A to Z)';
			case 'menu.data.sort_sheet_options.by_column_desc': return 'Sort sheet by column {index} (Z to A)';
			case 'menu.data.sort_range': return 'Sort range';
			case 'menu.data.sort_range_options.by_column_asc': return 'Sort range by column {index} (A to Z)';
			case 'menu.data.sort_range_options.by_column_desc': return 'Sort range by column {index} (Z to A)';
			...
			case 'column_menu.more_options.freeze': return 'Freeze up to column {index}';
			...
			case 'row_menu.more_options.freeze': return 'Freeze up to row {index}';
			...
			case 'bottom_bar.tab_name': return 'Sheet{index}';
